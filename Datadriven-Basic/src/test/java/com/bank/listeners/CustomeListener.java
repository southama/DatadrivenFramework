...
public class CustomeListener implements ITestListener{
	...
	public void onTestSuccess(ITestResult result) {
		Reporter.log("Test Pass "+result.getName().toUpperCase());
	}
	...
	public void onTestFailure(ITestResult result) {
		...
		Reporter.log("<br>");
		Reporter.log("<a target =\"-blank\" href ="+TestUtil.screenshotname+"><img height =200 width =200 src ="+TestUtil.screenshotname+"></a>");
